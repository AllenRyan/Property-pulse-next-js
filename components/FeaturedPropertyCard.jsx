             ...
             {getRateDisplay()}
              ...
              >
                {property.rates.nightly && (
                  <p><FaMoneyBill className="inline mr-2"/> {property.rates.nightly}</p>
                )}
                {property.rates.weekly && (
                  <p><FaMoneyBill className="inline mr-2"/> {property.rates.weekly}</p>
                )}
                {property.rates.monthly && (
                  <p><FaMoneyBill className="inline mr-2"/> {property.rates.monthly}</p>
                )}
